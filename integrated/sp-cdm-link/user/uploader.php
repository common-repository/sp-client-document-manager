...
class sp_cdm_link_uploader{
		...
		function save_embed(){
			...
			check_ajax_referer( 'sp_cdm_link_save_embed', 'nonce' );
...
$json = array();
	...
	$insert_file['url'] = sanitize_url($_POST['link-url']);
...
<input type="hidden" name="nonce" value="'.wp_create_nonce( 'sp_cdm_link_save_embed' ).'">
