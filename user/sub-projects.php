...
function recursor($datas, $parent = 0, $depth = 0,$chosen=0){
...
function recursor2( $array, $r = 0, $p = null,$chosen = 0) {
...
function project_dropdown($html,$chosen= false,$uid= 0){
	global $wpdb,$current_user;
	unset($html);
	$html = '';
